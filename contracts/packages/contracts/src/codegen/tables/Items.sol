...
library Items {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "memento", name: "Items", typeId: RESOURCE_TABLE });`
   ...
   * @notice Get ownerId.
   */
  function getOwnerId(bytes32 id) internal view returns (bytes32 ownerId) {
   ...
   * @notice Get ownerId.
   */
  function _getOwnerId(bytes32 id) internal view returns (bytes32 ownerId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set ownerId.
   */
  function setOwnerId(bytes32 id, bytes32 ownerId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((ownerId)), _fieldLayout);
  }

  /**
   * @notice Set ownerId.
   */
  function _setOwnerId(bytes32 id, bytes32 ownerId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreCore.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((ownerId)), _fieldLayout);
  }

  /**
   * @notice Get locationId.
   */
  function getLocationId(bytes32 id) internal view returns (bytes32 locationId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get locationId.
   */
  function _getLocationId(bytes32 id) internal view returns (bytes32 locationId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Set locationId.
   */
  function setLocationId(bytes32 id, bytes32 locationId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((locationId)), _fieldLayout);
  }

  /**
   * @notice Set locationId.
   */
  function _setLocationId(bytes32 id, bytes32 locationId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get rarity.
   */
  function getRarity(bytes32 id) internal view returns (string memory rarity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get rarity.
   */
  function _getRarity(bytes32 id) internal view returns (string memory rarity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set rarity.
   */
  function setRarity(bytes32 id, string memory rarity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreSwitch.setDynamicField(_tableId, _keyTuple, 1, bytes((rarity)));
  }

  /**
   * @notice Set rarity.
   */
  function _setRarity(bytes32 id, string memory rarity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreCore.setDynamicField(_tableId, _keyTuple, 1, bytes((rarity)));
  }

  /**
   * @notice Get the length of rarity.
   */
  function lengthRarity(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the length of rarity.
   */
  function _lengthRarity(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemRarity(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemRarity(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function pushRarity(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Push a slice to rarity.
   */
  function _pushRarity(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function popRarity(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Pop a slice from rarity.
   */
  function _popRarity(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function updateRarity(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Update a slice of rarity at `_index`.
   */
  function _updateRarity(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 id) internal view returns (ItemsData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
